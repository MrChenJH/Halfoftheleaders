                ...
                <View>
                    ...
                    <View style={{
                        ...
                        <View style={{marginRight: 5, width: 35}}>
                            <TouchableOpacity style={{height: 20, width: 20, marginRight: 10}} onPress={() => {
                                ...
                                <Image source={require('./imgs/tc.png')} resizeMode='stretch'
                    ...
                    <ScrollView scrollEnabled={true} style={{backgroundColor: '#F2F2F2'}}>
                        <TouchableOpacity onPress={() => {
                            this.setState({type: 5, typetitle: '活动内容简介'})
                        }}>
                            ...
                            <View
                                ...
                                <View style={{
                                    ...
                                    <Image source={require('./imgs/tx/mm.png')} style={{
                                        width: 48, height: 48
                        ...
                        <View style={{
                            ...
                            <Image source={require('./imgs/go.png')} style={{width: 10, height: 10, marginLeft: 5}}
                                   resizeMode='stretch'></Image>
                        </View>
            ...
            return (
                <View>
                    ...
                    <ScrollView
                        ...
                        <TouchableOpacity onPress={() => {
                            ...
                            <View style={{
                                ...
                                <View style={{flexDirection: 'row', alignItems: 'center'}}>
                                    <Image source={require('./imgs/tx/boy.png')} style={{width: 48, height: 48}}
                                           resizeMode='stretch'></Image>
                        ...
                        <TouchableOpacity onPress={() => {
                            this.setState({type: 4, typetitle: '昵称', typecontent: '上海'})
                        }}>
                        ...
                        <TouchableOpacity onPress={() => {
                            this.setState({type: 4, typetitle: '真实姓名', typecontent: '2018-9-1'})
                        }}>
                            <View style={{
                                flexDirection: 'row',
                                backgroundColor: '#fff',
                        ...
                        <TouchableOpacity onPress={() => {
                            this.setState({type: 4, typetitle: '性别', typecontent: '张三'})
                        }}>
                            <View style={{
                                flexDirection: 'row',
                                backgroundColor: '#fff',
                        ...
                        <TouchableOpacity onPress={() => {
                            this.setState({type: 4, typetitle: '联系地址', typecontent: '12222222'})
                        }}>
                            <View style={{
                                flexDirection: 'row',
                                backgroundColor: '#fff',
                        ...
                        <TouchableOpacity onPress={() => {
                            this.setState({type: 4, typetitle: '出生年月', typecontent: '5'})
                        }}>
                            <View style={{
                                flexDirection: 'row',
                                backgroundColor: '#fff',
