        ...
        AsyncStorage.getItem('user').then((item)=>{
         ...
         fetch(app.Host+'api/plans/tj?xgzh='+decodeURI(item.userName))
             ...
             .then((responseJson) => { 
               ...
               this.setState({jtnc:item.nc,xgzh:decodeURI(item.userName),realname:decodeURI(item.realName),dataList:ds.cloneWithRows(data),zjds:data1[0].zs,whjds:data1[0].w,yhjds:data1[0].y})
