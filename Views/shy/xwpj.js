                    ...
                    <View style={{
                        ...
                        <View style={{marginRight: 5, width: 35}}>
                            <TouchableOpacity style={{height: 20, width: 20, marginRight: 10}} onPress={() => {
                                ...
                                <Image source={require('./shyImage/add.png')} resizeMode='stretch'
                                       style={{height: 20, width: 20}}>
                                </Image>
                            </TouchableOpacity>
                        </View>
                        ...
                        renderRow={(rowData) =>
                            ...
                            <View
                                ...
                                <View style={{
                                    ...
                                    <Text style={{color: '#474747', width: 50}}>{decodeURI(rowData.realName)}</Text>
                                </View>
                                <View style={{
                                    flex: 4,
                                    justifyContent: 'center',
                                ...
                                <View style={{
                                    ...
                                    <Text style={{color: '#474747'}}>银豆 {rowData.yd}</Text>
                                </View>
                                <View style={{
                                    flex: 1,
                                    justifyContent: 'center',
